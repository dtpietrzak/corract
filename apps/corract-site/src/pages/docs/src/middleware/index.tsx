  ...
  return (
    <>
      ...
      <Text tag={'p'} color={'purple.hard'}>
        This number: <Code>{docsMiddleware.calls}</Code> represents how many times any docs page has been rendered since the last restart. Try disabling JavaScript in your browser—this count will still increase. That's because the count is tracked in the docs route's middleware, meaning the server renders and delivers the full page regardless of client-side JS. This highlights a core strength of Corract's SSR: complete page rendering without relying on JavaScript. Last render timestamp: <Code>{docsMiddleware.lastCall}</Code>.
      </Text>
